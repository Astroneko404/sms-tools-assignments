...
if __name__ == "__main__":
    x = genSine(1.0, 30, 0.0, 1000, 0.5) + genSine(1.0, 100, 0.0, 1000, 0.5) + genSine(1.0, 200, 0.0, 1000, 0.5)
    y, yfilt = suppressFreqDFTmodel(x, 1000, 1024)
    plt.plot(y)
    plt.show()
